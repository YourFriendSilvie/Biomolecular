    ...
    internal static List<TerrainScatterPrototype> Build()
    {
        return new List<TerrainScatterPrototype>
        {
            new TerrainScatterPrototype
            {
                ...
                spawnCount = 120,
                spawnDensityPer16x16Chunks = 77f,
            ...
            new TerrainScatterPrototype
            {
                ...
                spawnCount = 78,
                spawnDensityPer16x16Chunks = 50f,
            ...
            new TerrainScatterPrototype
            {
                ...
                spawnCount = 58,
                spawnDensityPer16x16Chunks = 37f,
            ...
            new TerrainScatterPrototype
            {
                ...
                spawnCount = 28,
                spawnDensityPer16x16Chunks = 18f,
            ...
            new TerrainScatterPrototype
            {
                ...
                spawnCount = 88,
                spawnDensityPer16x16Chunks = 56f,
